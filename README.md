...
- USB-RS485変換器
- モータドライバ: BLVD10KM
  - datasheet（通信編）: https://www.orientalmotor.co.jp/ja/system/files?file=product_detail/manual/HM-5101J.pdf  
  - datasheet: https://www.orientalmotor.co.jp/system/files/product_detail/manual/HM-5100J.pdf?serviceTypeNo=18&senimotoId=1&brandCode=BL&seriesCode=FJ00  
...
`blvrPropo` と同じ考え方で、`ch-C`/`ch-D`/`ch-H` のPWM入力を使って左右モータを直接制御します。  
